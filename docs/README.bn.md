...
3. **আপনার কাজ সংরক্ষণ করুন**:
   - **দ্রুত সংরক্ষণ** - আপনার ডিভাইসের লোকাল স্টোরেজে সংরক্ষণ করে
   - **রপ্তানি** - JSON ফাইল হিসাবে ডাউনলোড করুন
   - **আমদানি** - JSON ফাইল থেকে লোড করুন

### স্টোরেজ বিকল্প

- **লোকাল স্টোরেজ**: আপনার ডায়াগ্রাম ব্রাউজারের IndexedDB-এ সংরক্ষিত হয় এবং ব্রাউজার বন্ধ করলে বা ডিভাইস পুনরায় চালু করলেও টিকে থাকে
- **অটো-সেভ**: সম্পাদনা বন্ধ করার 5 সেকেন্ড পর পরিবর্তনগুলি স্বয়ংক্রিয়ভাবে সংরক্ষণ করে
- **রপ্তানি/আমদানি**: JSON ফাইল হিসাবে স্থায়ী স্টোরেজ
- **সার্ভার স্টোরেজ** (সেলফ-হোস্টেড): `ENABLE_SERVER_STORAGE` সক্রিয় থাকা অবস্থায় (ডিফল্টভাবে সক্রিয়) Docker-এর মাধ্যমে চালালে, ডায়াগ্রামগুলি হোস্টের `./diagrams`-এও সিঙ্ক হয়
