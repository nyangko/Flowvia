...
- `packages/flowvia-lib` - नेटवर्क डायग्राम बनाने के लिए React कंपोनेंट लाइब्रेरी (Webpack के साथ निर्मित)
...
3. **अपना काम सहेजें**:
   - **त्वरित सहेजें** - आपके डिवाइस के लोकल स्टोरेज में सहेजता है
   - **एक्सपोर्ट** - JSON फ़ाइल के रूप में डाउनलोड करें
   - **इम्पोर्ट** - JSON फ़ाइल से लोड करें

### स्टोरेज विकल्प

- **लोकल स्टोरेज**: डायग्राम आपके ब्राउज़र के IndexedDB में सहेजे जाते हैं और ब्राउज़र बंद करने या डिवाइस रीस्टार्ट करने के बाद भी बने रहते हैं
- **ऑटो-सेव**: संपादन रोकने के 5 सेकंड बाद बदलाव स्वचालित रूप से सहेजता है
- **एक्सपोर्ट/इम्पोर्ट**: JSON फ़ाइलों के रूप में स्थायी स्टोरेज
- **सर्वर स्टोरेज** (सेल्फ-होस्टेड): Docker के माध्यम से `ENABLE_SERVER_STORAGE` सक्षम (डिफ़ॉल्ट रूप से सक्षम) होने पर चलाने पर, डायग्राम होस्ट पर `./diagrams` में भी सिंक होते हैं
